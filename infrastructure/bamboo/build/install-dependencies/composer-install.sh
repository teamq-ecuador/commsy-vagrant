...
sudo docker-compose run --rm --volume $PWD/app/vendor:/php-vendor sso_composer composer install --no-ansi --no-interaction --no-progress --no-scripts --optimize-autoloader -d /var/www/app
