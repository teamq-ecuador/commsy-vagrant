...
sudo find $CONFIGPATH -type f -print0 | sudo xargs -0 sed -i "s/##testing_host##/$BRANCH.sso.tools.testing.giffits.de/g"
...
sudo find "$PWD" -type f -print0 | sudo xargs -0 sed -i "s/##testing_host##/$BRANCH.sso.tools.testing.giffits.de/g"
